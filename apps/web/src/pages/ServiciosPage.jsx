    ...
    <main className="theme-page pt-28">
      <section className="section-padding">
        <div className="container-page">
          ...
          >
            <p className="theme-accent text-sm font-bold uppercase tracking-[0.35em]">Servicios</p>
            <h1 className="theme-text mt-4 font-serif text-4xl font-bold sm:text-6xl">Todo para crear, regalar y comunicar</h1>
