export const brand = {
  ...
  owner: 'Alexandra Lopez',
  email: 'auraviolet@gmail.com',
...
export const galleryItems = [
  { title: 'Caja sorpresa romantica', category: 'Regalos personalizados' },
  { title: 'Ramo floral violeta', category: 'Detalles especiales' },
  { title: 'Kit grafico de marca', category: 'Diseno grafico' },
  { title: 'Cartelera educativa', category: 'Trabajos escolares' },
  { title: 'Invitacion elegante', category: 'Impresion creativa' },
  { title: 'Tarjeta artesanal', category: 'Papeleria creativa' },
  { title: 'Decoracion tematica', category: 'Manualidades' },
  { title: 'Etiquetas personalizadas', category: 'Stickers y empaques' },
  { title: 'Menu para negocio', category: 'Diseno e impresion' },
  { title: 'Detalle para aniversario', category: 'Regalos romanticos' },
  { title: 'Material didactico', category: 'Academico' },
  { title: 'Logo para emprendimiento', category: 'Identidad visual' },
]
...
export const values = ['Creatividad', 'Calidad', 'Originalidad', 'Cercania', 'Cumplimiento']
